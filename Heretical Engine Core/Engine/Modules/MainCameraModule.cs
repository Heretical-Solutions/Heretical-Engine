...
namespace HereticalSolutions.HereticalEngine.Modules
{
		...
		: IModule
	{
			...
			ApplicationContext context)
		{
			...
			{
				//inputContext.Mice[i].Cursor.CursorMode = CursorMode.Raw; //BASTARD! I WAS WONDERING WHY THE FUCK WAS THE CURSOR GONE BOTH FROM THE WINDOW AND FROM THE IDE EVERY TIME I START THE APPLICATION, MAKING IT FUCKING IMPOSSIBLE TO DEBUG OR SIMPLY CLOSE THE WINDOW WITH THE MOUSE. BE ADVISED: COPY CODE FROM TUTORIALS CAREFULLY
